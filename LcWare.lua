-- Made by scepty
if not isfolder("LcWare") then
    makefolder("LcWare")
    makefolder("LcWare/Assets")
    makefolder("LcWare/Sound")
    makefolder("LcWare/Sound/mc")
end
        ...
        local Window = Rayfield:CreateWindow({
            ...
            LoadingSubtitle = "Made By Scepty",
            ConfigurationSaving = {
                Enabled = true,
                FolderName = "LcWare",
            ...
            KeySettings = {
                ...
                Key = "weufhvivffifwergfw;grfwe2435543kjhlbfelkjhgrlkjhbge"
            }
        })
